...
COPY ["./eMoody/DAO/eMoody.DAO.csproj", "eMoody/DAO/"]
COPY ["./eMoody/Config/eMoody.Config.csproj", "eMoody/Config/"]
COPY ["./eMoody/Infrastructure/eMoody.Infrastructure.csproj", "eMoody/Infrastructure/"]
...
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./eMoody.Server.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
